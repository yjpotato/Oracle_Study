...
--STUDENT SNO, SNAME, MAJOR, SYEAR SCORE의 RESULT, SCGRAD의 GRADE가지는 테이블 생성

CREATE TABLE SCORE_GRADE2(SNO ,SNAME ,MAJOR ,SYEAR, RESULT ,GRADE)
        AS SELECT SNO,
        ST.SNAME, 
        ST.MAJOR,
        ST.SYEAR,
...
--1-3. 테이블으 삭제하는 DROP
CREATE TABLE SCORE_COPY2
    AS SELECT * FROM SCORE;
    
SELECT * FROM SCORE_COPY2;
    
--SCORE_COPY 테이블 삭제
DROP TABLE SCORE_COPY2;

--TIMESTAMP로 삭제된 데이터 조회
